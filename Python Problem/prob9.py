...
median = (np.log(sortdm[n]) + np.log(sortdm[m]))/2

# Plot histogram of dark matter mass together with mean and median
plt.hist(np.log(dm), bins=50, label='Data')
plt.xlabel('log of Dark Matter Mass ($10^{10}M_{\odot}$/h)')
